...
Rscript --vanilla glm_predict.R "WIAT_Comp"
Rscript --vanilla glm_predict.R "WIAT_Num"
Rscript --vanilla glm_predict.R "WIAT_Spelling"
Rscript --vanilla glm_predict.R "WIAT_Word_Reading"
